...
namespace NavJob.Systems
{
    ...
    public class NavMeshQuerySystem : JobComponentSystem
    {
        ...
        /// </summary>
        public int PendingCount => QueryQueue.Count;

        /// <summary>
        /// Cached path count
        /// </summary>
        public int CachedCount => cachedPaths.Count;
        ...
        private static NavMeshQuerySystem instance => _instance ?? (_instance = World.DefaultGameObjectInjectionWorld.GetOrCreateSystem<NavMeshQuerySystem>());
